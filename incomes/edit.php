...
$id = $_GET['id'];
$statement = $conn->prepare("SELECT date, category, amount, description FROM incomes where id = ?");
                        ...
                        <form action="update.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="category" class="form-select" id="category" required>
                                    ...
                                    <option value="freelance" <?php if ($row['category'] == 'freelance') {
                                                                    echo "selected";
                                                                } ?>>Freelance</option>
                                    <option value="gifts_donations" <?php if ($row['category'] == 'gifts_donations') {
                                                                        echo "selected";
